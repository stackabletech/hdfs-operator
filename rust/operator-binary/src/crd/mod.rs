...
impl KeyValueOverridesProvider for HdfsConfigOverrides {
...
pub type NameNodeRoleType =
    Role<NameNodeConfigFragment, HdfsConfigOverrides, GenericRoleConfig, JavaCommonConfig>;
pub type DataNodeRoleType =
    Role<DataNodeConfigFragment, HdfsConfigOverrides, GenericRoleConfig, JavaCommonConfig>;
pub type JournalNodeRoleType =
    Role<JournalNodeConfigFragment, HdfsConfigOverrides, GenericRoleConfig, JavaCommonConfig>;
...
impl v1alpha1::HdfsCluster {
    ...
    pub fn namenode_rolegroup(
        &self,
        role_group: &str,
    ) -> Option<&RoleGroup<NameNodeConfigFragment, JavaCommonConfig, HdfsConfigOverrides>> {
    ...
    pub fn datanode_rolegroup(
        &self,
        role_group: &str,
    ) -> Option<&RoleGroup<DataNodeConfigFragment, JavaCommonConfig, HdfsConfigOverrides>> {
    ...
    pub fn journalnode_rolegroup(
        &self,
        role_group: &str,
    ) -> Option<&RoleGroup<JournalNodeConfigFragment, JavaCommonConfig, HdfsConfigOverrides>> {
        self.spec
            .journal_nodes
            .as_ref()?
            .role_groups
