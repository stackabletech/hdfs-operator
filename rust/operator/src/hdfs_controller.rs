        ...
        match property_name_kind {
            ...
            PropertyNameKind::File(file_name) if file_name == CORE_SITE_XML => {
                core_site_xml = CoreSiteConfigBuilder::new(hdfs_name.to_string())
                    ...
                    .add("hadoop.registry.kerberos.realm","CLUSTER.LOCAL")
                    .add("dfs.web.authentication.kerberos.principal","HTTP/_HOST@CLUSTER.LOCAL")
                    .add("dfs.journalnode.kerberos.internal.spnego.principal","HTTP/_HOST@CLUSTER.LOCAL")
                    .add("dfs.journalnode.kerberos.principal","jn/_HOST@CLUSTER.LOCAL")
                    .add("dfs.journalnode.kerberos.principal.pattern","jn/*.simple-hdfs-journalnode-default.default.svc.cluster.local@CLUSTER.LOCAL")
