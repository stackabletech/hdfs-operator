...
:crd: {crd-docs}/hdfs.stackable.tech/hdfscluster/v1alpha1/
...
* The {crd-docs}/hdfs.stackable.tech/airflowcluster/v1alpha1/[HdfsCluster {external-link-icon}^] CRD documentation
